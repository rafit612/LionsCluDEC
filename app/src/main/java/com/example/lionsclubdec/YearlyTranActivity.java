...
public class YearlyTranActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yearly_tran);
        ...
        recview=findViewById(R.id.y_tran_rec);
        ...
        try {
            FirebaseRecyclerOptions<monthlymodel> options =
                    new FirebaseRecyclerOptions.Builder<monthlymodel>()
                            .setQuery(FirebaseDatabase.getInstance("https://lions-club-dec-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference().child("Club_Yearly_report").child(pid).child(currentDateandTime), monthlymodel.class)
                            .build();
