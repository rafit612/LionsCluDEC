...
public class MonthReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recview=findViewById(R.id.m_rec);
        ...
        Toast.makeText(getApplicationContext(),currentDateandTime2+currentDateandTime,Toast.LENGTH_LONG).show();
        try {
        ...
        protected void onBindViewHolder(@NonNull clubAdapter.myviewholder holder, int position, @NonNull clubmodel model)
        {
            ...
            holder.name.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(MonthReportActivity.this,MonthlyTransActivity.class);
